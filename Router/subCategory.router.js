...
router.get("/getAllSubCategory/:categoryType", Token.isAuthenticated(), subCategory.getAllSubCategory);

router.get("/getAllSubCategoryByMerchant/:merchantId", Token.isAuthenticated(), subCategory.getAllSubCategoryByMerchant);
