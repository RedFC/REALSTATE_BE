...
exports.connect_cache = function () {
  return new Promise((resolve, reject) => {
    client = redisClient({
      port: 14275, // replace with your port
      host: "redis-14275.c253.us-central1-1.gce.cloud.redislabs.com", // replace with your hostanme or IP address
      password: "MkNW6tHx9ENDNZ1umfcq9786SbKUwNP5", // replace with your password
    });
